...
public class ScreenControlActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screencontrol);
        mContext = this;
    ...
    private void bindServices() {
        // Bind UPnP service
        Intent upnpServiceIntent = new Intent(ScreenControlActivity.this, ClingUpnpService.class);
