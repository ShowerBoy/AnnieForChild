package com.annie.annieforchild.Utils.views.weekview;
...
public class WeekView extends View {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
             ...
             * ep1
             */
//            StaticLayout textLayout = new StaticLayout(dayLabel, mEventTextPaint, 2, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
//            canvas.translate(startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding);
