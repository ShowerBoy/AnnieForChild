...
public class SelectReadingFragment extends BaseFragment implements ScheduleView {
    ...
    public static SelectReadingFragment instance(Schedule schedule, String date) {
        SelectReadingFragment fragment = new SelectReadingFragment();
    ...
    protected void initData() {
        ...
        presenter.getMaterialClass(1);
    }

    @Override
    protected void initView(View view) {
        expandableListView = view.findViewById(R.id.select_reading_list);
        recyclerView = view.findViewById(R.id.select_reading_recycler);
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
    ...
    public void onMainEventThread(JTMessage message) {
        if (message.what == MethodCode.EVENT_GETALLMATERIALLIST2) {
            groupList.clear();
            childList.clear();
            lists.clear();
