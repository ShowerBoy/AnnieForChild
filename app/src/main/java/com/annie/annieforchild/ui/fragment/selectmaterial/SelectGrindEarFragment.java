...
public class SelectGrindEarFragment extends BaseFragment implements ScheduleView {
    ...
    protected void initData() {
        ...
        presenter.getMaterialClass(0);
    }

    @Override
    protected void initView(View view) {
        expandableListView = view.findViewById(R.id.select_grind_ear_list);
        recyclerView = view.findViewById(R.id.select_grind_ear_recycler);
...
//        recyclerView.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
    ...
    public void onMainEventThread(JTMessage message) {
        if (message.what == MethodCode.EVENT_GETALLMATERIALLIST1) {
            groupList.clear();
            childList.clear();
            lists.clear();
    ...
    protected int getLayoutId() {
        return R.layout.activity_select_grindear_fragment;
    }
