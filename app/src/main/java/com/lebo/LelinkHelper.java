...
public class LelinkHelper {
    ...
    private static final String APP_ID = "12330";
    private static final String APP_SECRET = "e5180a137e44401b032a2a4762e1d224";
    ...
    public void startMirror(AliyunPlayerSkinActivity activity, LelinkServiceInfo info, int resolutionLevel,
