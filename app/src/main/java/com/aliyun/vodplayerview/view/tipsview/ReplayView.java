...
public class ReplayView extends RelativeLayout implements ITheme {
    //重播按钮
    private TextView mReplayBtn,mRreplayExit;
    //重播事件监听
    ...
    private void init() {
        ...
        mRreplayExit = (TextView) view.findViewById(R.id.replay_exit);
        ...
        mRreplayExit.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnReplayClickListener != null) {
                    mOnReplayClickListener.onExit();
                }
            }
        });
