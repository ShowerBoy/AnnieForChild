...
public class AlivcShowScreenDialog extends Dialog {
    ...
    public AlivcShowScreenDialog(@NonNull Context context) {
        this(context, AliyunScreenMode.Full);
    }



    public AlivcShowScreenDialog(Context context, AliyunScreenMode aliyunScreenMode) {
...
//        }
    ...
    public int dipToPx(float dp) {
        //获得当前手机dp与px的转换关系
        float scale = mContentView.getResources().getDisplayMetrics().density;
        ...
        set.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mContentView.post(new Runnable() {
                    ...
                    public void run() {
                        try {
                            AlivcShowScreenDialog.super.dismiss();
                        } catch (Exception e) {
